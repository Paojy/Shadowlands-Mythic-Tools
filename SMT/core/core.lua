...
T.HL_OnRaid = function(v, t, target, sourceGUID)
	...
	local hasElvUI  = _G["ElvUF_Raid"] and _G["ElvUF_Raid"]:IsVisible() or IsAddOnLoaded("ElvUI")
	local hasElvUI2 = _G["ElvUF_Party"] and _G["ElvUF_Party"]:IsVisible() or IsAddOnLoaded("ElvUI")
